...
from chef_validator.version import version_info
...
latex_documents = [
  (master_doc, 'fi-ware-chef_validator.tex', u'fi-ware-chef\\_validator Documentation',
...
man_pages = [
    (master_doc, 'fi-ware-chef_validator', u'fi-ware-chef_validator Documentation',
     [author], 1)
]
